...
├── src/
│   ├── App.astro        # Componente padre que compone las secciones (entrada de la app)
│   ├── seo/              # SEO.astro (meta/OG/Twitter/JSON-LD)
│   ├── layouts/          # Layout.astro (shell HTML + Header/Footer + estilos)
│   ├── pages/            # Rutas (index.astro)
│   ├── components/       # ui/ (primitivos React: Button, Marquee, Reveal, TextLoop,
│   │                     #   Grainient, StickerTrail) + Container.astro
